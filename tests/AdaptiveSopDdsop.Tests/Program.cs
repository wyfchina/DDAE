...
static void TestScenarioRunWorkspaceReplacesTeachingPageShell()
{
    ...
    AssertTrue(!networkPartial.Contains("id=\"candidate-action-combination-panel\"", StringComparison.Ordinal), "network partial should not expose candidate action combination UI in the scoring product");
    ...
    AssertTrue(!networkProductPage.Contains("id=\"candidate-action-combination-panel\"", StringComparison.Ordinal), "network scoring should not expose candidate action combination panel");
    AssertTrue(!networkProductPage.Contains("id=\"candidate-combination-solver-select\"", StringComparison.Ordinal), "network scoring should not expose solver selector");
    AssertTrue(!networkProductPage.Contains("id=\"select-candidate-combinations\"", StringComparison.Ordinal), "network scoring should not expose candidate combination button");
    AssertTrue(!networkProductPage.Contains("id=\"candidate-combination-status\"", StringComparison.Ordinal), "network scoring should not expose solver status");
    AssertTrue(!networkProductPage.Contains("id=\"candidate-combination-list\"", StringComparison.Ordinal), "network scoring should not expose candidate combination list");
    ...
    AssertTrue(!networkProductPage.Contains("候选动作组合选择", StringComparison.Ordinal), "network product should not show candidate combination selection label");
    AssertTrue(!networkProductPage.Contains("选择候选组合", StringComparison.Ordinal), "network product should not show candidate combination selection action");
    AssertTrue(!networkProductPage.Contains("组合选择器", StringComparison.Ordinal), "network product should not show solver as a combination selector");
    ...
    AssertTrue(networkProductPage.Contains("评分候选", StringComparison.Ordinal), "network product should keep scoring candidates as the primary output");
    ...
    AssertTrue(networkScript.Contains("businessText", StringComparison.Ordinal), "network script should keep business text translation for backend labels");
    ...
    AssertTrue(!networkScript.Contains("networkRenderMultiScenarioComparison(result)", StringComparison.Ordinal), "network structure script should not route deferred candidate combinations into scenario comparison rendering");
    ...
    AssertTrue(!networkCss.Contains(".candidate-combination-list", StringComparison.Ordinal), "network stylesheet should not expose candidate combination styles while the feature is deferred");
    ...
    AssertTrue(!networkCss.Contains(".candidate-combination-card", StringComparison.Ordinal), "network stylesheet should not expose candidate combination cards while the feature is deferred");
    ...
    AssertTrue(!networkCss.Contains("#candidate-action-combination-panel", StringComparison.Ordinal), "network stylesheet should not style a hidden candidate combination panel");
    ...
    AssertTrue(!networkScript.Contains("solverName", StringComparison.Ordinal), "network module should not expose solver controls while candidate combinations are deferred");
    ...
    AssertTrue(!networkScript.Contains("正在选择候选动作组合", StringComparison.Ordinal), "network module should not show candidate combination selection progress while the feature is deferred");
    ...
    AssertTrue(css.Contains("overflow-x: auto", StringComparison.Ordinal), "wide network tables and maps should keep horizontal scroll inside containers");
    AssertTrue(!css.Contains(".is-focused-panel .candidate-combination-list", StringComparison.Ordinal), "focused candidate combination layout should be absent while the feature is deferred");
    ...
    AssertTrue(!networkScript.Contains("/api/candidate-action-combinations/select", StringComparison.Ordinal), "network module should not call candidate action combination API while the feature is deferred");
